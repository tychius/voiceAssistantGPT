...
__all__ = [
    'ISpeechLexiconPronunciations', 'SRCS_Enabled',
    'SpeechCategoryAudioIn', 'SPAR_Medium', 'SRSEIsSpeaking',
    'SLTUser', 'SVP_20', 'DISPID_SRRTimes', 'ISpeechPhraseRule',
    'SVP_10', 'DISPID_SASFreeBufferSpace', 'DISPID_SPPsItem',
    'SVSFParseSsml', 'UINT_PTR', 'SpeechTokenIdUserLexicon',
    'SPWORDPRONUNCIATION', 'IInternetSecurityManager',
    'DISPID_SpeechXMLRecoResult', 'DISPID_SRRAlternates',
    'SGLexicalNoSpecialChars', 'DISPID_SOTMatchesAttributes',
    'SPEI_RESERVED2', 'SPEVENTENUM', 'SpeechEmulationCompareFlags',
    'SPEI_TTS_PRIVATE', 'ISpObjectWithToken', 'SpeechAllElements',
    'DISPID_SpeechWaveFormatEx', 'SpeechAudioFormatType',
    'DISPID_SOTCGetDataKey', 'DISPID_SMSALineId', 'DISPID_SMSSetData',
    'SWTAdded', 'SLOStatic', 'STSF_LocalAppData',
    'ISpeechPhraseInfoBuilder', 'SpCustomStream',
    'SPEI_END_SR_STREAM', 'SpeechPropertyResourceUsage', 'SVP_2',
    'ISpeechTextSelectionInformation', 'DISPID_SAFType',
    'SpeechInterference', 'SAFTCCITT_uLaw_44kHzStereo',
    'IEnumSpObjectTokens', 'ISpeechGrammarRule', 'ISpEventSource',
    'DISPID_SDKDeleteKey', 'DISPID_SBSRead', 'DISPID_SGRSTText',
    'DISPID_SLPs_NewEnum', 'SINoise', 'SITooFast',
    'ISpPhoneConverter', 'SRESoundStart', 'Speech_StreamPos_RealTime',
    'DISPID_SPCIdToPhone', 'ISpDataKey',
    'DISPID_SPIGetDisplayAttributes', 'STSF_CommonAppData',
    'SPEI_INTERFERENCE', 'DISPID_SVAlertBoundary',
    'DISPID_SRGDictationSetState', 'SpShortcut', 'SP_VISEME_10',
    'SPXMLRESULTOPTIONS', 'ISpRecognizer3',
    'SAFTCCITT_uLaw_8kHzStereo', 'ISpeechPhraseProperties',
    'DISPID_SPARecoResult', 'DISPID_SpeechPhraseInfo',
    'DISPID_SRGCommit', 'SPINTERFERENCE_LATENCY_WARNING',
    'DISPID_SPRDisplayAttributes', 'DISPID_SpeechPhraseRules',
    'DISPID_SFSOpen', 'ISpGrammarBuilder', 'SPEI_START_INPUT_STREAM',
    'DISPID_SVEventInterests', 'DISPIDSPTSI_ActiveLength',
    'SAFT8kHz16BitMono', 'DISPID_SpeechObjectTokens',
    'SPBINARYGRAMMAR', 'SPINTERFERENCE_TOOSLOW', 'ISpeechAudio',
    'ISpeechRecoResultTimes', 'DISPID_SABIBufferSize',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'ISpEventSink', 'SPPS_Modifier',
    'SP_VISEME_5', 'SpPhraseInfoBuilder', 'DISPID_SVAudioOutput',
    'SpeechRetainedAudioOptions', 'SPPHRASERULE', 'SREPhraseStart',
    'DISPID_SVPriority', 'eLEXTYPE_RESERVED4', 'SPPS_RESERVED1',
    'SPAO_RETAIN_AUDIO', 'SPSHT_Unknown',
    'SpeechRegistryLocalMachineRoot', 'SVEWordBoundary',
    'SpNotifyTranslator', 'SREFalseRecognition',
    ...
    'DISPID_SGRSTPropertyValue', 'DISPID_SPAsCount', 'SITooSlow',
    'DISPID_SVStatus', 'DISPID_SVEAudioLevel',
    'SpeechEngineConfidence', 'SAFT24kHz8BitStereo',
    'SpeechVoiceSpeakFlags', 'SFTSREngine', 'DISPID_SVGetVoices',
    'SPGS_EXCLUSIVE', 'DISPID_SRRTOffsetFromStart',
    'DISPID_SVIsUISupported', 'SPLOADOPTIONS', 'ISpeechVoice',
    'SVEAllEvents', 'SPSLMA', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'DISPID_SPRsItem', 'SPSHORTCUTPAIR', 'SpeechDisplayAttributes',
    'ISpeechObjectTokenCategory', 'DISPID_SpeechObjectToken',
    'ISpeechPhraseReplacements', 'SGRSTTWord',
    'SPDKL_DefaultLocation', 'SPEI_SR_RETAINEDAUDIO',
    'DISPID_SPRuleName', 'SAFT48kHz8BitMono',
    'SAFTCCITT_uLaw_22kHzMono', 'STCLocalServer',
    'DISPID_SRRTTickCount', 'SVEStartInputStream', 'ISpRecoResult',
    'SGRSTTRule', 'DISPID_SpeechRecognizerStatus', 'SRADynamic',
    'SpeechGrammarState', 'SREAdaptation', 'DISPID_SGRSTRule',
    'DISPID_SpeechDataKey', 'SRAImport', 'eLEXTYPE_LETTERTOSOUND',
    'DISPID_SRRTStreamTime', 'DISPID_SBSFormat', 'eLEXTYPE_PRIVATE15',
    'SpVoice', 'DISPID_SPELexicalForm',
    'DISPID_SASCurrentSeekPosition', 'DISPID_SpeechRecoResultTimes',
    'SVPAlert', 'SPPS_Unknown', 'DISPID_SAStatus', 'SP_VISEME_0',
    'SpResourceManager', 'SWPUnknownWordPronounceable',
    'eLEXTYPE_PRIVATE3', 'DISPID_SPEAudioStreamOffset',
    'DISPID_SGRInitialState', 'SpeechCategoryAppLexicons',
    'SAFT12kHz8BitMono', 'SPSHT_EMAIL',
    'DISPID_SpeechLexiconPronunciation', 'DISPID_SRCVoicePurgeEvent',
    'eLEXTYPE_PRIVATE9', 'DISPID_SVEPhoneme',
    'DISPID_SLRemovePronunciationByPhoneIds', 'SPFM_OPEN_READONLY',
    'DISPID_SPEAudioSizeTime', 'DISPID_SRGCmdSetRuleState',
    'DISPID_SPPName', 'DISPID_SOTsItem', 'SSFMCreateForWrite',
    'SPRULE', 'SPPS_NotOverriden', 'DISPID_SPRuleEngineConfidence',
    'SPEI_HYPOTHESIS', 'SVPNormal', 'DISPID_SGRClear',
    'SpeechTokenShellFolder', 'DISPID_SPPEngineConfidence',
    'SREPropertyNumChange', 'SPSModifier', 'SpObjectToken', 'SVP_8',
    'SpeechVoicePriority', 'DISPID_SRCEPropertyStringChange',
    'SPEI_MIN_TTS', 'eLEXTYPE_APP', 'eLEXTYPE_PRIVATE17',
    'DISPID_SPIRule', 'SBONone', 'SGRSTTDictation', 'SPAR_Low',
    'DISPID_SPAStartElementInResult', 'SAFTADPCM_44kHzStereo',
    'DISPID_SLGetPronunciations', 'DISPID_SRCEPropertyNumberChange',
    'SPRST_INACTIVE', 'SpInProcRecoContext', 'DISPID_SRSAudioStatus',
    'SVP_4', 'SGPronounciation', 'SRSEDone',
    'DISPID_SVGetAudioOutputs', 'SPINTERFERENCE_TOOQUIET', 'SASStop',
    'SDTAll', 'DISPID_SPERetainedSizeBytes', 'SECFIgnoreKanaType',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'DISPID_SPPsCount',
    'SAFT8kHz16BitStereo', 'SVSFParseMask', 'SpSharedRecoContext',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'SAFT8kHz8BitStereo',
    'SAFT44kHz8BitStereo', 'DISPID_SPIEnginePrivateData',
    'SpeechDiscardType', 'DISPID_SRGRecoContext', 'SP_VISEME_18',
    'DISPID_SGRs_NewEnum', 'DISPID_SCSBaseStream',
    'DISPID_SWFESamplesPerSec', 'DISPID_SPIGetText',
    'DISPID_SPCPhoneToId', 'SPPHRASEELEMENT', 'IEnumString',
    'DISPID_SBSSeek', 'SPVPRI_OVER', 'eWORDTYPE_ADDED', 'LONG_PTR',
    'DISPID_SPRulesItem', 'DISPID_SPIAudioStreamPosition',
    'ISpeechPhraseElements', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'SECFDefault', 'SAFTCCITT_uLaw_8kHzMono', 'ISpSerializeState',
    'ISpeechMMSysAudio', 'SPRST_ACTIVE_ALWAYS',
    'DISPID_SRCCreateGrammar', 'DISPID_SpeechVoice', 'SP_VISEME_11',
    'SPRST_INACTIVE_WITH_PURGE', 'SAFT11kHz16BitStereo',
    'ISpeechLexiconWords', 'SAFTADPCM_11kHzStereo',
    'DISPID_SRSNumberOfActiveRules', 'DISPID_SGRSTPropertyName',
    'DISPID_SOTId', 'DISPID_SOTRemoveStorageFileName',
    'SpUnCompressedLexicon', 'eLEXTYPE_RESERVED8',
    'SAFT48kHz16BitMono', 'SpeechRecoEvents', 'SVP_9',
    'SpeechGrammarTagWildcard', 'SpWaveFormatEx',
    'DISPID_SPRules_NewEnum', 'SRAONone', 'DISPID_SMSGetData',
    'SPBO_TIME_UNITS', 'ISpeechPhoneConverter',
    'DISPID_SRCAudioInInterferenceStatus', 'DISPID_SWFEChannels',
    'ISpShortcut', 'ISpResourceManager', 'SAFTGSM610_8kHzMono',
    'SpeechGrammarWordType', 'DISPID_SpeechCustomStream',
    'DISPID_SRRSpeakAudio', 'DISPID_SRGetPropertyString',
    'SVSFNLPSpeakPunc',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet', 'SPAR_Unknown',
    'DISPID_SpeechVoiceStatus', 'SVSFIsNotXML', 'IStream',
    'DISPID_SVESentenceBoundary', 'ISpObjectTokenCategory',
    'DISPID_SRGCmdLoadFromFile', 'SpMMAudioOut', 'ISpeechLexiconWord',
    'DISPID_SLPsItem', 'DISPID_SRGSetTextSelection',
    'DISPID_SVVolume', 'DISPID_SVSInputSentencePosition', 'SVP_7',
    'DISPID_SpeechGrammarRuleStateTransition',
    'DISPID_SpeechPhraseAlternate', 'SVSFlagsAsync',
    'DISPID_SPRuleChildren', 'SVP_5', 'ISpRecoContext2',
    'SpeechGrammarTagUnlimitedDictation', 'Speech_Default_Weight',
    'eLEXTYPE_PRIVATE12', 'DISPID_SDKGetStringValue',
    'SPGRAMMARSTATE', 'SpeechStreamSeekPositionType',
    'SPEI_SR_AUDIO_LEVEL', 'DISPID_SPPParent', 'SVEPrivate',
    'eLEXTYPE_PRIVATE10', 'DISPID_SRCEBookmark', 'SPPS_Interjection',
    'SVSFPurgeBeforeSpeak', 'SPPHRASEREPLACEMENT',
    'SpeechMicTraining', 'ISpeechAudioStatus', 'DISPID_SOTs_NewEnum',
    'SPWT_DISPLAY', 'DISPID_SDKSetLongValue',
    'DISPID_SRGDictationLoad', 'SINoSignal', 'DISPID_SLGenerationId',
    'DISPID_SRRAudio', 'SRAORetainAudio', 'DISPID_SOTRemove',
    'SpStream', 'SPEI_REQUEST_UI', 'DISPID_SRGCmdLoadFromMemory',
    'SPSFunction', 'SAFT11kHz8BitMono', 'SPEI_PROPERTY_STRING_CHANGE',
    'DISPID_SRSetPropertyNumber', '__MIDL_IWinTypes_0009',
    'DISPID_SRRGetXMLResult', 'SAFTDefault', 'SAFT24kHz8BitMono',
    'SPPS_LMA', 'DISPID_SpeechRecoContext', 'SAFT22kHz8BitStereo',
    'eLEXTYPE_USER', 'SDTDisplayText', 'SVSFDefault', 'SPPS_Verb',
    'DISPID_SpeechLexiconWord', 'SECLowConfidence',
    'DISPID_SMSADeviceId', 'SAFTCCITT_ALaw_8kHzStereo',
    'SAFT32kHz16BitStereo', 'STCAll', 'DISPID_SPPValue',
    'DISPID_SPIRetainedSizeBytes', 'DISPID_SpeechRecognizer',
    'SPDKL_CurrentUser', 'SSFMCreate', 'DISPID_SPRs_NewEnum',
    ...
    'DISPID_SVSLastBookmarkId', 'SpeechPartOfSpeech',
    'DISPID_SGRsDynamic', 'DISPID_SRRSaveToMemory', 'SPAO_NONE',
    ...
    'SAFT32kHz16BitMono', 'DISPID_SGRSTNextState',
    'DISPID_SRSCurrentStreamPosition', 'DISPID_SPISaveToMemory',
    'SGSExclusive', 'SP_VISEME_4', 'DISPID_SLWLangId',
    'SpeechPropertyLowConfidenceThreshold', 'SpeechAudioVolume',
    'SAFTCCITT_uLaw_22kHzStereo', 'SPCATEGORYTYPE', 'SDTAlternates',
    'SPSMF_SRGS_SAPIPROPERTIES', 'ISpeechBaseStream',
    'DISPID_SVAudioOutputStream', 'STCRemoteServer',
    'SAFTNonStandardFormat', 'DISPID_SGRSTransitions',
    'SPBOOKMARKOPTIONS', 'SPEI_PHONEME', 'SPPHRASE',
    'SPGRAMMARWORDTYPE', 'SPPS_Noun', 'DISPID_SPRuleFirstElement',
    'SSSPTRelativeToEnd', 'SpInprocRecognizer', 'SGRSTTTextBuffer',
    'DISPID_SRCPause', 'SRAInterpreter', 'SRSActive',
    'DISPID_SPAs_NewEnum', 'SpObjectTokenCategory',
    'DISPID_SpeechMMSysAudio', 'SPVPRI_NORMAL',
    'DISPID_SDKGetlongValue', 'DISPID_SABIMinNotification',
    'SDA_One_Trailing_Space', 'SVP_13', 'SRTReSent',
    'SAFT44kHz16BitMono', 'eLEXTYPE_PRIVATE18', 'SRTExtendableParse',
    'ISpRecoGrammar2', 'DISPID_SVSpeakStream', 'SAFTADPCM_8kHzMono',
    'DISPID_SPEs_NewEnum', 'ISpeechPhraseAlternates',
    'SPINTERFERENCE_TOOLOUD', 'SPSInterjection', 'DISPID_SOTSetId',
    'DISPID_SPEPronunciation', 'SpeechAudioState',
    'SPADAPTATIONRELEVANCE', 'DISPID_SASCurrentDevicePosition',
    'DISPID_SRGId', 'SPSNotOverriden', 'SPWORDTYPE',
    'DISPID_SPEDisplayText', 'DISPID_SVEViseme', 'WAVEFORMATEX',
    'DISPID_SLPsCount', 'SpeechRuleAttributes',
    'SREPropertyStringChange', 'eLEXTYPE_RESERVED7',
    'SPRECOGNIZERSTATUS', 'DISPID_SRAudioInput',
    'SpeechGrammarTagDictation', 'SRTSMLTimeout',
    'SDA_Two_Trailing_Spaces', 'SPWORD', 'SpMMAudioIn',
    'SpeechRecognitionType', 'SDKLCurrentConfig',
    'DISPID_SPIElements', 'SP_VISEME_12', 'DISPID_SRState',
    'SDTProperty', 'DISPID_SRCCreateResultFromMemory',
    'DISPID_SpeechRecoResult2', 'SpNullPhoneConverter', 'SRTStandard',
    'SDTRule', 'ISpeechRecognizer', 'DISPID_SRCCmdMaxAlternates',
    'DISPID_SRCESoundStart', 'SRAExport', 'SPPS_RESERVED2',
    'SPWF_SRENGINE', 'SPEI_RECOGNITION', 'SAFTGSM610_11kHzMono',
    'ISpeechWaveFormatEx', 'SPSHORTCUTTYPE', 'DISPID_SOTCDefault',
    'DISPID_SGRSAddSpecialTransition', 'SPCT_DICTATION',
    'DISPID_SVSyncronousSpeakTimeout', 'DISPID_SRRecognizer',
    'SPPARTOFSPEECH', 'SRCS_Disabled', 'SECFIgnoreCase',
    'SAFT22kHz8BitMono', 'DISPID_SpeechPhraseReplacement',
    'SAFT24kHz16BitStereo', 'SVSFParseSapi', 'SRARoot',
    'SDTPronunciation', 'eLEXTYPE_PRIVATE16', 'SPVOICESTATUS',
    'SPEI_SOUND_END', 'SpeechLoadOption', 'DISPID_SAFGuid',
    'ISpeechResourceLoader', 'SAFT16kHz16BitMono', 'DISPID_SGRSRule',
    'DISPID_SRRGetXMLErrorInfo', 'STCInprocServer',
    'DISPID_SVSInputSentenceLength', 'DISPID_SRGRules',
    'SP_VISEME_13', 'DISPID_SRIsUISupported',
    'DISPID_SLRemovePronunciation', 'SPVISEMES', 'SPAUDIOSTATE',
    'DISPID_SPAPhraseInfo', 'SGDSActive', 'ISpRecognizer2',
    'SDA_No_Trailing_Space', 'SPSMF_UPS', 'SpeechRunState',
    'SPRECOCONTEXTSTATUS', 'DISPID_SGRsAdd', 'SPSHORTCUTPAIRLIST',
    'DISPID_SPPBRestorePhraseFromMemory', 'ISpeechRecoResultDispatch',
    'DISPID_SRRTLength', 'DISPID_SPPConfidence',
    'SpeechCategoryVoices', 'DISPID_SRStatus', 'DISPID_SPIEngineId',
    'DISPIDSPTSI_SelectionLength', 'SECHighConfidence',
    'ISpeechObjectTokens', 'DISPID_SPCLangId', 'SpeechLexiconType',
    'SPSEMANTICFORMAT', 'SPAS_CLOSED', 'SpeechTokenKeyUI',
    'DISPID_SPRNumberOfElements',
    'SpeechPropertyHighConfidenceThreshold', 'DISPID_SASState',
    'SPEI_WORD_BOUNDARY', 'SAFT11kHz8BitStereo',
    'DISPID_SPIProperties', 'SDTReplacement',
    'DISPID_SPPNumberOfElements', 'SPBO_PAUSE', 'SAFT16kHz8BitStereo',
    'DISPID_SRGDictationUnload', 'DISPID_SABufferNotifySize',
    'SITooLoud', 'ISpeechRecoResult', 'SpeechRuleState',
    'SPDKL_LocalMachine', 'SGSDisabled', 'SPRECOSTATE',
    'SPRECORESULTTIMES', 'SPSEMANTICERRORINFO', 'SPPROPERTYINFO',
    'SAFT12kHz16BitStereo', 'DISPID_SRRRecoContext',
    'DISPID_SGRSTsItem', 'SPXRO_Alternates_SML', 'SVP_6',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'SpeechAudioFormatGUIDWave', 'SAFT11kHz16BitMono',
    'DISPID_SLWPronunciations', 'SP_VISEME_8', 'SREAudioLevel',
    'DISPID_SRCEStartStream', 'ISpeechDataKey', 'SVP_16',
    'SRTEmulated', 'SAFT16kHz8BitMono', 'SSFMOpenReadWrite',
    'SPCT_SLEEP', 'SPAUDIOOPTIONS', 'DISPID_SRCRecognizer',
    'DISPID_SpeechLexicon', 'DISPID_SGRSAddRuleTransition',
    'SWPUnknownWordUnpronounceable', 'SpeechFormatType',
    'SPLO_STATIC', 'DISPID_SPACommit',
    'DISPID_SPANumberOfElementsInResult', 'DISPID_SABIEventBias',
    'SGDSInactive', 'SPWAVEFORMATTYPE', 'DISPID_SPIAudioSizeBytes',
    'SPEI_VOICE_CHANGE', 'SPCT_COMMAND', 'SPSSuppressWord',
    'DISPID_SWFEBitsPerSample', 'SPRS_ACTIVE', 'DISPID_SLPSymbolic',
    'SRESoundEnd', 'DISPID_SpeechFileStream', 'SpeechDataKeyLocation',
    'DISPID_SOTCategory', 'DISPID_SVSInputWordPosition',
    'DISPID_SGRsCommit', 'DISPID_SPIGrammarId',
    'DISPID_SPEAudioSizeBytes', 'SDTLexicalForm', 'DISPID_SVVoice',
    'eLEXTYPE_PRIVATE20', 'DISPID_SRCERecognizerStateChange',
    'SPEI_RESERVED3', 'DISPID_SWFEFormatTag', 'SPRST_NUM_STATES',
    'eLEXTYPE_PRIVATE2', 'DISPID_SpeechGrammarRuleState',
    'eLEXTYPE_VENDORLEXICON', 'SpeechPropertyComplexResponseSpeed',
    'DISPID_SPERetainedStreamOffset', 'SpeechSpecialTransitionType',
    'SPSUnknown', 'DISPID_SRRAudioFormat', 'SVP_15',
    'eLEXTYPE_RESERVED9', 'DISPID_SGRAddResource',
    'DISPID_SAFSetWaveFormatEx', 'SVP_21',
    ...
    'DISPID_SpeechAudioFormat', 'SPWT_LEXICAL', 'SRERecoOtherContext',
    'SPAUDIOBUFFERINFO', 'SPEI_VISEME', 'DISPID_SpeechLexiconProns',
    'DISPID_SOTCEnumerateTokens', 'SSFMOpenForRead', 'SPRST_ACTIVE',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', '_RemotableHandle',
    'DISPID_SLPPartOfSpeech', 'SVP_19', 'SPPS_RESERVED3',
    'DISPID_SLAddPronunciationByPhoneIds', 'SPCS_DISABLED',
    'DISPID_SRCEInterference', 'SAFTCCITT_ALaw_8kHzMono',
    'DISPID_SVRate', 'DISPID_SDKCreateKey', 'SPEVENT',
    'SAFTADPCM_22kHzStereo', 'DISPID_SpeechPhraseReplacements',
    'SPCT_SUB_COMMAND', 'DISPID_SPEEngineConfidence',
    'DISPID_SPEsCount', 'DISPID_SpeechPhraseElement', 'SPEI_MAX_TTS',
    'DISPID_SOTDataKey', 'DISPID_SpeechGrammarRule',
    'DISPID_SVSVisemeId', 'DISPIDSPRG', 'SPEI_PHRASE_START',
    'SpTextSelectionInformation', 'SAFTGSM610_22kHzMono',
    'SAFT22kHz16BitStereo', 'DISPID_SRProfile',
    'SpeechCategoryRecognizers', 'ISpStream', 'SAFT48kHz8BitStereo',
    'SGRSTTWildcard', 'SVP_1', 'DISPID_SPIReplacements',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'SVEEndInputStream',
    'eWORDTYPE_DELETED', 'SAFTCCITT_ALaw_11kHzStereo', 'SVF_None',
    'ISpeechLexiconPronunciation', 'SpeechEngineProperties',
    'SPAS_STOP', 'DISPID_SADefaultFormat', 'ISpeechXMLRecoResult',
    'DISPID_SPPId', 'SP_VISEME_15', 'DISPID_SpeechAudioBufferInfo',
    'SP_VISEME_16', 'DISPID_SLPPhoneIds',
    'SDA_Consume_Leading_Spaces', 'DISPID_SWFEBlockAlign',
    'ISpeechGrammarRuleStateTransitions', 'ISpRecoGrammar',
    'eLEXTYPE_PRIVATE7', 'SpeechUserTraining', 'SPEVENTSOURCEINFO',
    'Speech_Max_Word_Length', 'DISPID_SPRulesCount', 'SRERecognition',
    'DISPID_SRCEFalseRecognition', 'SpeechBookmarkOptions',
    'SDTAudio', 'DISPID_SGRSTs_NewEnum', 'DISPID_SPAsItem',
    'ISpeechLexicon', 'SPEI_FALSE_RECOGNITION', 'STSF_AppData',
    'DISPID_SpeechGrammarRules', 'SPSERIALIZEDRESULT',
    'SpeechTokenValueCLSID', 'SpStreamFormatConverter', 'SVP_18',
    'SPEI_RESERVED5', 'SECFIgnoreWidth', 'SpAudioFormat',
    'SpMemoryStream', 'SVEPhoneme', 'eLEXTYPE_PRIVATE11',
    'SRADefaultToActive', 'ISpeechAudioBufferInfo',
    'ISpeechObjectToken', 'SVF_Stressed', 'DISPID_SpeechBaseStream',
    'DISPID_SpeechPhraseAlternates', 'SPSERIALIZEDPHRASE',
    'SDKLCurrentUser', 'SpeechTokenKeyFiles', 'DISPID_SPRsCount',
    'DISPID_SLGetGenerationChange', 'DISPID_SRGSetWordSequenceData',
    'SpeechVisemeFeature', 'SPEI_ADAPTATION', 'DISPID_SRDisplayUI',
    'SpeechVoiceCategoryTTSRate', 'ISpeechRecoGrammar',
    'STSF_FlagCreate', 'DISPID_SLGetWords', 'SPWORDLIST',
    'SAFTNoAssignedFormat', 'SAFT16kHz16BitStereo',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'SDKLDefaultLocation',
    'SREStateChange', 'eLEXTYPE_PRIVATE8', 'ISpXMLRecoResult',
    'ISpPhrase', 'SVEViseme', 'SpeechWordPronounceable',
    'DISPID_SLWsItem', 'SAFTCCITT_uLaw_11kHzMono', 'SpeechVisemeType',
    ...
    'SECFEmulateResult', 'SpeechStreamFileMode',
    'DISPID_SRRDiscardResultInfo', 'DISPID_SRCSetAdaptationData',
    'DISPID_SpeechPhoneConverter', 'SGSEnabled', 'SPVPRIORITY',
    'SPBO_AHEAD', 'SAFTCCITT_ALaw_11kHzMono', 'SPFM_CREATE',
    'DISPID_SVSInputWordLength', 'SPTEXTSELECTIONINFO',
    'DISPID_SpeechRecoResult', 'SpeechCategoryPhoneConverters',
    'DISPID_SRAudioInputStream', 'SPEI_TTS_BOOKMARK',
    'ISpeechPhraseElement', 'DISPID_SREmulateRecognition',
    'DISPID_SRGCmdLoadFromObject', 'ISpRecognizer',
    'SPEI_SOUND_START', 'DISPID_SRSCurrentStreamNumber', 'SITooQuiet',
    'DISPID_SPILanguageId', 'DISPID_SVResume',
    'DISPID_SpeechPhraseProperty', 'DISPID_SLAddPronunciation',
    'DISPID_SDKDeleteValue', 'SPFM_CREATE_ALWAYS',
    'eLEXTYPE_PRIVATE13', 'DISPID_SGRsCommitAndSave',
    'eLEXTYPE_PRIVATE4', 'DISPID_SVEStreamEnd', 'SPINTERFERENCE',
    'SREBookmark', 'DISPID_SDKSetStringValue', 'SRSActiveAlways',
    'STCInprocHandler', 'SSTTWildcard', '_SPAUDIOSTATE',
    'SVSFIsFilename', 'SPRS_ACTIVE_USER_DELIMITED',
    'SAFT24kHz16BitMono', 'SVEAudioLevel',
    'SpeechCategoryRecoProfiles', 'SVESentenceBoundary',
    'DISPID_SOTGetStorageFileName',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'DISPID_SWFEExtraData',
    'DISPID_SRCEHypothesis', 'DISPID_SRGetFormat',
    'SPEI_PROPERTY_NUM_CHANGE', 'SPSMF_SAPI_PROPERTIES',
    'SpeechTokenContext', 'SSTTDictation', 'SPLO_DYNAMIC',
    'SAFT12kHz16BitMono', 'DISPID_SRCEEnginePrivate',
    'SPSHT_NotOverriden', 'SAFT44kHz8BitMono',
    'DISPID_SRCRetainedAudioFormat', 'SAFTCCITT_uLaw_11kHzStereo',
    'DISPID_SDKOpenKey', 'DISPID_SRCreateRecoContext', 'SP_VISEME_1',
    'SP_VISEME_6', 'SPSHT_OTHER', 'DISPID_SRGState',
    'SPWORDPRONUNCIATIONLIST', 'SGLexical', 'SPPS_SuppressWord',
    'SPCS_ENABLED', 'ISpPhoneticAlphabetConverter',
    'SPEI_RECO_STATE_CHANGE', 'ISpRecoCategory',
    'DISPID_SABufferInfo', 'DISPID_SASetState', 'DISPID_SpeechAudio',
    'DISPID_SGRAttributes', 'DISPID_SpeechPhraseElements',
    'ISpeechPhraseProperty', 'SPWF_INPUT', 'DISPID_SVWaitUntilDone',
    'DISPID_SVSPhonemeId', 'DISPID_SVEBookmark', 'SpMMAudioEnum',
    'DISPID_SVSkip', 'DISPID_SRCESoundEnd', 'SAFT8kHz8BitMono',
    '_ISpeechVoiceEvents', 'SECNormalConfidence', 'SINone',
    'SpeechAudioProperties', 'DISPID_SPIStartTime', 'DISPID_SRCVoice',
    'ISpPhraseAlt', 'SPWORDPRONOUNCEABLE', 'SVP_17', 'SLODynamic',
    'SAFTGSM610_44kHzMono', 'SASClosed', 'ISequentialStream',
    'SPSVerb', 'ISpeechRecognizerStatus', 'Speech_StreamPos_Asap',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet', 'SpeechWordType',
    'SSTTTextBuffer', 'DISPID_SDKEnumKeys', 'SpCompressedLexicon',
    'DISPID_SRGCmdSetRuleIdState', 'DISPIDSPTSI', 'SPEI_MAX_SR',
    'DISPID_SGRId', 'ISpVoice', 'SP_VISEME_14', 'SPRS_INACTIVE',
    'SP_VISEME_3', 'DISPID_SRCRequestedUIType', 'SREHypothesis',
    'DISPID_SRSClsidEngine', 'SAFT48kHz16BitStereo',
    'DISPID_SpeechPhraseRule', 'DISPID_SLWWord', 'SECFNoSpecialChars',
    'DISPID_SPPs_NewEnum', 'SRSInactiveWithPurge',
    'DISPID_SpeechObjectTokenCategory', 'ISpAudio',
    'DISPID_SPRuleNumberOfElements', 'ISpeechCustomStream',
    'ISpLexicon', 'DISPID_SRCERecognition', 'SPEI_MIN_SR',
    'DISPID_SDKEnumValues', 'SAFT44kHz16BitStereo',
    'DISPID_SVDisplayUI', 'SpeechAddRemoveWord', 'SVP_3',
    'SpeechRegistryUserRoot', 'SPAR_High',
    'SpeechVoiceSkipTypeSentence', 'DISPID_SLWsCount',
    'IInternetSecurityMgrSite', 'SAFTCCITT_ALaw_44kHzStereo',
    'DISPID_SRCResume', 'SPEI_START_SR_STREAM', 'SP_VISEME_19',
    'SVSFPersistXML', 'SPEI_SR_BOOKMARK', 'SVP_11', 'SPRULESTATE',
    'SPGS_DISABLED', 'ISpeechFileStream', 'tagSTATSTG',
    'SPCT_SUB_DICTATION', 'SPVPRI_ALERT', 'DISPID_SpeechAudioStatus',
    'DISPID_SpeechGrammarRuleStateTransitions', 'SVF_Emphasis',
    'DISPID_SAEventHandle', 'DISPID_SPRuleParent',
    'DISPID_SRCERequestUI', 'SPFM_OPEN_READWRITE',
    'SAFT32kHz8BitStereo', 'ISpeechAudioFormat',
    'DISPID_SpeechRecoContextEvents', 'SRERequestUI',
    'SpeechTokenKeyAttributes', 'SAFTExtendedAudioFormat',
    'SAFTCCITT_ALaw_22kHzMono', 'DISPIDSPTSI_ActiveOffset',
    'DISPIDSPTSI_SelectionOffset', 'SAFTTrueSpeech_8kHz1BitMono',
    'DISPID_SpeechLexiconWords', 'SASPause',
    'DISPID_SOTIsUISupported', 'DISPID_SVEVoiceChange',
    'eLEXTYPE_MORPHOLOGY', 'DISPID_SOTGetDescription',
    'eLEXTYPE_PRIVATE19', 'DISPID_SOTCreateInstance',
    'ISpeechRecoContext', 'SpeechRecognizerState',
    'DISPID_SRCEPhraseStart', 'SVEBookmark', 'eLEXTYPE_PRIVATE6',
    'SREPrivate', 'DISPID_SOTDisplayUI', 'SAFTCCITT_ALaw_44kHzMono',
    'DISPID_SRCEventInterests', 'SPINTERFERENCE_NOISE',
    'DISPID_SPIAudioSizeTime', 'ISpeechPhraseInfo',
    'DISPID_SRCEEndStream', 'SpeechRecoContextState',
    'DISPID_SRRPhraseInfo', 'ISpStreamFormat',
    'DISPID_SRGetPropertyNumber', 'SpFileStream', 'DISPID_SRCState',
    'SVEVoiceChange', 'DISPID_SRGCmdLoadFromResource',
    'DISPID_SVPause', 'SVSFVoiceMask', 'ISpNotifySink',
    'ISpeechVoiceStatus', 'SP_VISEME_2',
    'SpeechRecoProfileProperties', 'DISPID_SGRName',
    'DISPID_SLPLangId', 'SREStreamStart', 'SpPhoneConverter',
    'ISpStreamFormatConverter', 'DISPID_SRCEAdaptation',
    'SAFTADPCM_11kHzMono', 'DISPID_SRCEAudioLevel', 'ISpMMSysAudio',
    'DISPID_SGRSTPropertyId', 'DISPID_SGRSTsCount',
    'ISpPhoneticAlphabetSelection', 'SpPhoneticAlphabetConverter',
    'SAFT22kHz16BitMono', 'DISPID_SRIsShared', 'SSSPTRelativeToStart',
    'DISPID_SLWType', 'SVSFNLPMask', 'SPWT_PRONUNCIATION',
    'eLEXTYPE_PRIVATE1', 'ISpRecoContext',
    'DISPID_SPEAudioTimeOffset', 'SP_VISEME_20', 'DISPID_SOTsCount',
    'DISPID_SPEDisplayAttributes', 'SpSharedRecognizer',
    'ISpeechPhraseReplacement', 'SPEI_TTS_AUDIO_LEVEL',
    'SP_VISEME_17', 'SGRSTTEpsilon', 'DISPID_SDKSetBinaryValue',
    'DISPID_SGRsFindRule', 'SPSNoun', 'SPEI_RESERVED1',
    'SAFTADPCM_44kHzMono', 'DISPID_SOTCSetId', 'SREAllEvents',
    'ISpNotifyTranslator', 'DISPID_SVSpeakCompleteEvent', 'SVPOver',
    'SP_VISEME_7', 'DISPID_SPEsItem', 'DISPID_SVEStreamStart',
    ...
    'DISPID_SGRsCount', 'DISPID_SGRAddState', 'DISPID_SPRuleId',
    'DISPID_SAFGetWaveFormatEx', 'SRATopLevel', 'DISPID_SGRSTType',
    'SRTAutopause', 'SPXRO_SML', 'SPEI_RECO_OTHER_CONTEXT',
    'ISpObjectToken', 'SGDisplay', 'DISPID_SRGetRecognizers',
    'SFTInput', 'SPFILEMODE', 'SPINTERFERENCE_TOOFAST', 'SVP_14',
    'ISpeechMemoryStream', 'SRSInactive', 'DISPID_SVSLastBookmark',
    'DISPID_SLPType', 'Speech_Max_Pron_Length', 'SVP_0',
    'DISPID_SPRFirstElement', 'SREInterference',
    'eLEXTYPE_RESERVED10', 'SPAS_PAUSE', 'SP_VISEME_9',
    'SPPS_RESERVED4', 'SWTDeleted', 'SPEI_UNDEFINED',
    'ISpeechPhraseAlternate', 'DISPID_SOTGetAttribute',
    'DISPID_SpeechPhraseProperties', 'SAFT32kHz8BitMono',
    'DISPID_SOTCId', 'DISPID_SRSSupportedLanguages',
    'SPDATAKEYLOCATION', 'DISPID_SAVolume',
    'SWPKnownWordPronounceable', 'SPINTERFERENCE_NOSIGNAL',
    'SP_VISEME_21', 'DISPID_SRRSetTextFeedback', 'ISpeechPhraseRules',
    'DISPID_SVGetProfiles', 'SPCONTEXTSTATE',
    'DISPID_SVEEnginePrivate',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'DISPID_SBSWrite', 'DISPID_SVSpeak', 'SAFTCCITT_uLaw_44kHzMono',
    'DISPID_SRGIsPronounceable', 'SAFT12kHz8BitStereo',
    'eLEXTYPE_PRIVATE14', 'ISpProperties', 'SPPS_Function',
    'SPSTREAMFORMATTYPE', 'SpeechAudioFormatGUIDText',
    'DISPID_SPPChildren', 'DISPID_SPRText',
    'DISPID_SPERequiredConfidence', 'DISPID_SVEWord',
    'DISPID_SASNonBlockingIO', 'SLTApp', 'SPBO_NONE',
    'DISPID_SRGReset', 'eLEXTYPE_RESERVED6', 'DISPID_SGRsItem',
    'SPEI_SENTENCE_BOUNDARY', 'SAFTCCITT_ALaw_22kHzStereo',
    'SPFM_NUM_MODES', 'DISPID_SGRSTWeight', 'DISPID_SPPFirstElement',
    'SPLEXICONTYPE', 'tagSPPROPERTYINFO', 'DISPID_SPRuleConfidence',
    'SREStreamEnd', 'SPAS_RUN', 'SPEI_SR_PRIVATE',
    'SpeechVoiceEvents', 'DISPID_SpeechPhraseBuilder',
    'SPINTERFERENCE_NONE', 'DISPID_SVGetAudioInputs',
    'DISPID_SRCRetainedAudio', 'SPEI_RESERVED6',
    'DISPID_SGRSAddWordTransition', 'SPPS_Noncontent', 'SPGS_ENABLED',
    'SPEI_END_INPUT_STREAM', 'SGDSActiveWithAutoPause',
    'SPPHRASEPROPERTY', 'SpLexicon', 'SPAUDIOSTATUS',
    'SDKLLocalMachine', 'DISPID_SWFEAvgBytesPerSec',
    'ISpeechGrammarRules', 'SAFTADPCM_8kHzStereo', 'DISPID_SFSClose',
    'SpeechGrammarRuleStateTransitionType', 'SVP_12',
    'eLEXTYPE_USER_SHORTCUT', 'SVSFIsXML', 'SBOPause'
]

_check_version('1.1.14', 1618820306.317057)
